    ...
    <Box sx={{ bgcolor: 'white', height: '100%' }}>
      <Box sx={{ border: '1px solid #efefef', borderLeft: 'none', borderBottom: 'none' }}>
        ...
        <List>
          ...
          <ListItem sx={{ paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec' }} button onClick={() => setActiveComponent('CustomerSupport')}>
          ...
          <ListItem sx={{ paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec' }} button onClick={() => setActiveComponent('Profile')}>
          ...
          <ListItem sx={{ paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec' }} button onClick={() => setActiveComponent('Wallet')}>
